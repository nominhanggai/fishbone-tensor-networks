...
METHODS = {s.name: s for s in [
    # -- chain -------------------------------------------------------------
    _m("mpo-tdvp1", "schrodinger", ("chain",), "mpo-tdvp",
       "tdvp1", fixed_bond=True, layout="operator"),
    _m("mpo-tdvp2", "schrodinger", ("chain",), "mpo-tdvp", "tdvp2", layout="operator"),
    _m("mpo-dtdvp", "schrodinger", ("chain",), "mpo-tdvp",
    ...
    _m("polaron-tdvp1", "polaron", ("chain",), "mpo-tdvp",
       "tdvp1", fixed_bond=True, layout="operator"),
    _m("polaron-tdvp2", "polaron", ("chain",), "mpo-tdvp", "tdvp2",
       layout="operator"),
    _m("polaron-dtdvp", "polaron", ("chain",), "mpo-tdvp",
       "dtdvp", fixed_bond=True, layout="operator"),
    # -- star --------------------------------------------------------------
    _m("mpo-star-tdvp1", "schrodinger", ("star",), "mpo-tdvp",
       "tdvp1", fixed_bond=True, layout="operator"),
    _m("mpo-star-tdvp2", "schrodinger", ("star",), "mpo-tdvp",
       "tdvp2", layout="operator"),
    _m("mpo-ip-tdvp1", "interaction", ("star",), "mpo-tdvp",
       "tdvp1", fixed_bond=True, layout="operator"),
    _m("mpo-ip-tdvp2", "interaction", ("star",), "mpo-tdvp",
       "tdvp2", layout="operator"),
    # -- mode-tree ---------------------------------------------------------
