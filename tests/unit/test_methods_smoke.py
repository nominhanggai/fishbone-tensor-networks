...
@pytest.mark.parametrize("module,cls", [("frames.coolingchain", "SimpleSysBathCoolingChain")])
def test_cooling_shares_the_canonical_engine(module, cls):
    ...
    assert "SimpleSysBathMPS" in bases
...
def test_public_api_surface():
    ...
    for name in ("SimpleSysBathMPS", "FishBoneNet", "FishBoneH",
